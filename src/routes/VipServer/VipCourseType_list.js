...
@Form.create()
export default class VipCourseType extends PureComponent {
  state = {
    modalVisible: false,
    modalTitle: '',
    formValues: {},
    ...
    Modal.confirm({
      ...
      onOk() {
        dispatch({
          ...
          path: 'vipCourseType/remove',
          payload: { vipCourseTypeId: record.vipCourseTypeId },
          callback: cb
        });
      },
      onCancel() {}
  ...
  getDataForUpdate = record => {
    ...
    dispatch({
      ...
      path: 'vipCourseType/getDataForUpdate',
      payload: { vipCourseTypeId: record.vipCourseTypeId }
    });
    this.setState({
      modalTitle: '修改',
