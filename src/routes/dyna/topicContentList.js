...
import CreateEditForm from './topicContentEdit';
import CreateFindForm from './topicContentFind';
...
@Form.create()
export default class DynaTopicContent extends PureComponent {
  state = {
    modalVisible: false,
    modalTitle: '',
    formValues: {},
    ...
    Modal.confirm({
      ...
      onOk() {
        dispatch({
          ...
          path: 'dyna/topicContent',
          payload: { dynaTopicContentId: record.dynaTopicContentId },
          callback: cb
        });
      },
      onCancel() {}
  ...
  getDataForAdd = fields => {
    ...
    dispatch({
      ...
      path: 'dyna/topicContent/getDataForAdd',
      payload: fields
    });
    this.setState({
      modalTitle: '新增',
  ...
  getDataForUpdate = record => {
    ...
    dispatch({
      ...
      path: 'dyna/topicContent/getDataForUpdate',
      payload: { dynaTopicContentId: record.dynaTopicContentId }
    });
    this.setState({
      modalTitle: '修改',
  ...
  render() {
    ...
    const columns = [
      {
        title: '系统id',
        dataIndex: 'dynaTopicContentId'
      },
      {
        title: '话题内容',
        dataIndex: 'dynaTopicContent'
      },
      {
        title: '操作',
        render: (text, record) => (
