...
@Form.create()
export default class CourseAuthor extends PureComponent {
state = {
modalVisible: false,
modalTitle: '',
formValues: {},
...
path: 'courseAuthor/remove',
payload: {courseAuthorId:record.courseAuthorId},
callback:cb
});
},
onCancel() {
...
path: 'courseAuthor/getDataForAdd',
payload: fields,
});
this.setState({
modalTitle: '新增',
...
path: 'courseAuthor/getDataForUpdate',
payload: {courseAuthorId:record.courseAuthorId},
});
this.setState({
modalTitle: '修改',
