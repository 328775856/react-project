...
import CreateEditForm from './CourseTag_edit';
import CreateFindForm from './CourseTag_find';
...
@Form.create()
export default class CourseTag extends PureComponent {
state = {
modalVisible: false,
modalTitle: '',
formValues: {},
...
path: 'courseTag/remove',
payload: {courseTagId:record.courseTagId},
callback:cb
});
},
onCancel() {
...
path: 'courseTag/getDataForUpdate',
payload: {courseTagId:record.courseTagId},
});
this.setState({
modalTitle: '修改',
