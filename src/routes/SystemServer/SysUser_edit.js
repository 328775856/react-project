...
const CreateEditForm = Form.create()(props => {
  ...
  if(!isEmptyObject(props.state.options)){
    options = props.state.options.map(item => <Option key={item.sysRoleId}>{item.roleName}</Option>);
  }
const okHandle = () => {
...
return (
  ...
  >
    <FormItem {...formItemLayout} label="编号">
      {form.getFieldDecorator('userCode', {initialValue:formData.userCode ||'',
    rules: [
    {
    required: true,
    message: '请输入编号...',
    ...
    <FormItem {...formItemLayout} label="名称">
      {form.getFieldDecorator('userName', {initialValue:formData.userName ||'',
    rules: [
    {
    required: true,
    message: '请输入名称...',
    ...
    <FormItem {...formItemLayout} label="登录密码">
      {form.getFieldDecorator('passwd', {initialValue:formData.passwd ||'',
    rules: [
    {
    required: true,
    message: '请输入登录密码...',
    ...
    <FormItem {...formItemLayout} label="备注">
      {form.getFieldDecorator('remark', {initialValue:formData.remark ||'',
    rules: [
    {
    required: true,
    message: '请输入备注...',
