...
import CreateConditionForm from './SelectAuthor_condition';
...
@Form.create()
export default class SelectAuthor extends React.Component {
  state = {
    selectedRows: [],
    formValues: {},
  ...
  query = (params, page) => {
    const { dispatch, courseAuthorId } = this.props;
    this.setState({ courseAuthorId: courseAuthorId });
    dispatch({
      type: 'restTableData/list',
      path: 'courseAuthor/page',
      payload: {
        data: params,
        page
      }
  ...
  render() {
    ...
    const rowSelection = {
      ...
      onChange: (selectedRowKeys, selectedRows) => {
        ...
        this.setState({ courseAuthorId: selectedRows[0].courseAuthorId });
      },
      ...
      getCheckboxProps: record => {
        ...
        return {
          checked: record.courseAuthorId === courseAuthorId
        };
      }
    };
