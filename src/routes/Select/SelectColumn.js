...
export default class SelectColumn extends React.Component {
  ...
  query = (params, page) => {
    const { dispatch, courseColumnId } = this.props;
    this.setState({ courseColumnId: courseColumnId });
    dispatch({
  ...
  render() {
    ...
    const rowSelection = {
      ...
      onChange: (selectedRowKeys, selectedRows) => {
        ...
        this.setState({ courseColumnId: selectedRows[0].courseColumnId });
      },
      ...
      getCheckboxProps: record => {
        const { courseColumnId } = this.state;
        return {
          checked: record.courseColumnId === courseColumnId
        };
      }
    };
