    ...
    return (
      ...
      <Card bordered={false}>
        <Form onSubmit={this.handleSubmit} hideRequiredMark style={{ marginTop: 8 }}>
          ...
          <Row gutter={0}>
            <Col span={22}>
              {getFieldDecorator('code', {initialValue:formData.imagePath ||'',
            ...
            <Col span={2}>
              <Button onClick={this.selectUser} icon="search"></Button>
            </Col>
          </Row>
          </FormItem>
      ...
      <SelectImage {...parentMethods} modalVisible={modalVisible}/>
    </PageHeaderLayout>
    );
  }
}
