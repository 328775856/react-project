...
import CreateEditForm from './FindNotice_edit';
import CreateFindForm from './FindNotice_find';
...
export default class MediaArticle extends PureComponent {
    ...
    Modal.confirm({
      ...
      onOk() {
        dispatch({
          ...
          path: 'findNotice/remove',
          payload: { findNoticeId: record.findNoticeId },
          callback: cb
        });
      },
      onCancel() {}
  ...
  getDataForUpdate = record => {
    ...
    dispatch({
      ...
      path: 'findNotice/getDataForUpdate',
      payload: { findNoticeId: record.findNoticeId }
    });
    this.setState({
      modalTitle: '修改',
