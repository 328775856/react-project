...
return (
  ...
  >
    <FormItem {...formItemLayout} label="名称">
      {form.getFieldDecorator('propName', {initialValue:formData.propName ||'',
    rules: [
    {
    required: true,
    message: '请输入名称...',
    ...
    <FormItem {...formItemLayout} label="是否可借">
      {form.getFieldDecorator('isLend', {initialValue:formData.isLend === undefined ? '1' : `${formData.isLend  }` || '',
    rules: [
    {
    required: true,
    message: '请选择是否可借...',
    ...
    <FormItem {...formItemLayout} label="借阅天数">
      {form.getFieldDecorator('dayLend', {initialValue:formData.dayLend ||'',
    rules: [
    {
    required: true,
    message: '请输入借阅天数...',
    ...
    <FormItem {...formItemLayout} label="是否限制">
      {form.getFieldDecorator('isLimit', {initialValue:formData.isLimit === undefined ? '1' : `${formData.isLimit  }` || '',
    rules: [
    {
    required: true,
    message: '请选择是否限制...',
