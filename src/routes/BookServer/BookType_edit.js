...
return (
  ...
  >
    <FormItem {...formItemLayout} label="分类名称">
      {form.getFieldDecorator('typeName', {initialValue:formData.typeName ||'',
    rules: [
    {
    required: true,
    message: '请输入分类名称...',
    ...
    <FormItem
      ...
      style={{ display: 'none' }}
    >
      {form.getFieldDecorator('parentId', { initialValue: formData.parentId || '' })(
        <Input />
      )}
    </FormItem>
    ...
    <FormItem {...formItemLayout} label="是否禁用">
      {form.getFieldDecorator('isForbid', {initialValue:formData.isForbid === undefined ? '0' : `${formData.isForbid  }` || '',
    rules: [
    {
    required: true,
    message: '请选择是否禁用...',
