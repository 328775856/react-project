    ...
    return (
      ...
      >
        ...
        <FormItem {...formItemLayout} label="存储文件名">
          {form.getFieldDecorator('fileName', {initialValue:formData.fileName ||'',
            rules: [
              {
                required: true,
                message: '请输入存储文件名...',
        ...
        <FormItem {...formItemLayout} label="资源大小">
          {form.getFieldDecorator('fileSize', {initialValue:formData.fileSize ||'',
            rules: [
              {
                required: true,
                message: '请输入资源大小...',
        ...
        <SelectBookType {...parentMethodsForBookType} modalVisible={this.state.bookTypeModalVisible} />
        <SelectBookProp {...parentMethodsForBookProp} modalVisible={this.state.bookPropModalVisible} />
        <SelectBookStyle {...parentMethodsForBookStyle} modalVisible={this.state.bookStyleModalVisible} />
        <SelectBookStorage {...parentMethodsForBookStorage} modalVisible={this.state.bookStorageModalVisible} />
