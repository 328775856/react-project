...
import CreateEditForm from './GateClient_edit';
import CreateFindForm from './GateClient_find';
...
export default class TableList extends PureComponent {
  ...
  refresh() {
    ...
    dispatch({
      type: 'crud/list',
      path: 'gateClient/getGateClientPage',
      payload: {
        page: {
          pageNo: 1,
          pageSize: 10,
  ...
  updateSave = fields => {
    ...
    dispatch({
      ...
      path: 'gateClient/updateGateClient',
      payload: fields,
    });
  ...
  delete = record => {
    ...
    dispatch({
      type: 'crud/delete',
      path: 'gateClient/deleteGateClient',
      payload: { id: record.id },
    });
