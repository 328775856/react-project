...
@Form.create()
export default class MediaArticleGroup extends PureComponent {
state = {
modalVisible: false,
modalTitle: '',
formValues: {},
...
<PageHeaderLayout>
    ...
    <CreateEditForm {...parentMethods} modalVisible={modalVisible} formData={restTableData.formData} title={modalTitle}/>
</PageHeaderLayout>
);
}
}
