...
const menuData = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: '系统用户分析标签', path: 'sysAnalysisTag' }
    ]
  },
  {
    name: '图书',
    ...
    children: [
      ...
      { name: '购买图书', path: 'bookBuy' },
      { name: '流通图书', path: 'bookShare' },
  ...
  },
  {
    ...
    icon: 'table',
    path: 'userServer',
    children: [{ name: '用户反馈', path: 'userFeedback' }]
  },
  {
    name: '用户上传图书',
    icon: 'table',
    path: 'uploadbookServer',
    children: [{ name: '用户上传的图书信息', path: 'uploadBook' }]
  },
  {
    name: '订单',
    icon: 'table',
    path: 'orderServer',
    children: [
      { name: '订单产品类型', path: 'orderProductType' },
      { name: '产品', path: 'orderProduct' }
    ]
  },
  {
    name: '课程',
    ...
    path: 'courseServer',
    children: [
      { name: '作者', path: 'courseAuthor' },
      { name: '专栏', path: 'courseColumn' },
      { name: '标签', path: 'courseTag' },
      { name: '课程', path: 'courseInfo' },
      { name: '章节', path: 'courseChapter' }
    ]
  },
  {
    name: '权益',
    icon: 'table',
    path: 'priServer',
    children: [{ name: '权益', path: 'priFunction' }, { name: '权益包', path: 'priPackage' }]
  },
  {
    name: 'vip',
    icon: 'table',
