...
var charsContent = [
  {
    ...
    title: lang.tsfh,
    content: toArray(
      '♔,♕,♖,♚,♛,♜,❄,❅,❆,❖,★,☆,✦,✪,✫,✿,❀,❁,ღ,✔,✘,✓,✕,☑,☒,☋,☊,ㄨ,♂,♀,❧,✍,✎,✑,✄,❂,卍,❦,♘,♞,♣,♥,♡,☀,☂,♫,☎,☺,<hr>,·,ˉ,ˇ,¨,〃,々,—,～,‖,…,‘’,“”,〔〕,〈〉,《》,「」,『』,〖〗,【】,±,×,÷,∶,∧,∨,∑,∏,∪,∩,∈,∷,√,⊥,∥,∠,⌒,⊙,∫,∮,≡,≌,≈,∽,∝,≠,≮,≯,≤,≥,∞,∵,∴,♂,♀,°,′,″,¤,￠,￡,§,<hr>,○,●,©,◎,◇,◆,※,〓,〡,〢,〣,〤,〥,〦,〧,〨,〩,囍,㊣,㊤,㊦,㊥,㊧,㊨,㊐,㊊,㊌,㊍,㊎,㊏,㊛,㊚,<hr>,㎎,㎏,㎜,㎝,㎞,㎡,㏄,㏎,㏑,㏒,㏕,‰,℅,℉,℃,＄,№'
    ),
  },
  //罗马数字 { name:"lmsz", title:lang.lmsz, content:toArray("ⅰ,ⅱ,ⅲ,ⅳ,ⅴ,ⅵ,ⅶ,ⅷ,ⅸ,ⅹ,Ⅰ,Ⅱ,Ⅲ,Ⅳ,Ⅴ,Ⅵ,Ⅶ,Ⅷ,Ⅸ,Ⅹ,Ⅺ,Ⅻ")},
  {
    ...
    title: lang.szfh,
    content: toArray(
      "⒈,⒉,⒊,⒋,⒌,⒍,⒎,⒏,⒐,⒑,⒒,⒓,⒔,⒕,⒖,⒗,⒘,⒙,⒚,⒛,<hr>,⑴,⑵,⑶,⑷,⑸,⑹,⑺,⑻,⑼,⑽,⑾,⑿,⒀,⒁,⒂,⒃,⒄,⒅,⒆,⒇,<hr>,①,②,③,④,⑤,⑥,⑦,⑧,⑨,⑩,⑪,⑫,⑬,⑭,⑮,⑯​,<hr>,<span style='font-size:20px;'>❶</span>&nbsp;,<span style='font-size:20px;'>❷</span>&nbsp;,<span style='font-size:20px;'>❸</span>&nbsp;,<span style='font-size:20px;'>❹</span>&nbsp;,<span style='font-size:20px;'>❺</span>&nbsp;,<span style='font-size:20px;'>❻</span>&nbsp;,<span style='font-size:20px;'>❼</span>&nbsp;,<span style='font-size:20px;'>❽</span>&nbsp;,<span style='font-size:20px;'>❾</span>&nbsp;,<span style='font-size:20px;'>➓</span>&nbsp;,<hr>,㈠,㈡,㈢,㈣,㈤,㈥,㈦,㈧,㈨,㈩,<hr>,ⅰ,ⅱ,ⅲ,ⅳ,ⅴ,ⅵ,ⅶ,ⅷ,ⅸ,ⅹ,<hr>,Ⅰ,Ⅱ,Ⅲ,Ⅳ,Ⅴ,Ⅵ,Ⅶ,Ⅷ,Ⅸ,Ⅹ,Ⅺ,Ⅻ"
    ),
  },
  {
    name: 'jtfh',
  ...
  },
  {
    ...
    title: '拼音/音标',
    content: toArray(
      'ā,á,ǎ,à,ē,é,ě,è,ī,í,ǐ,ì,ō,ó,ǒ,ò,ū,ú,ǔ,ù,ǖ,ǘ,ǚ,ǜ,ü,<hr>,i:,i,e,æ,ʌ,ə:,ə,u:,u,ɔ:,ɔ,a:,ei,ai,ɔi,əu,au,iə,εə,uə,p,t,k,b,d,g,f,s,ʃ,θ,h,v,z,ʒ,ð,tʃ,tr,ts,dʒ,dr,dz,m,n,ŋ,l,r,w,j,'
    ),
  },
  ...
  },
  {
    ...
    title: '希腊/俄文',
    content: toArray(
      'Α,Β,Γ,Δ,Ε,Ζ,Η,Θ,Ι,Κ,Λ,Μ,Ν,Ξ,Ο,Π,Ρ,Σ,Τ,Υ,Φ,Χ,Ψ,Ω,<hr>,α,β,γ,δ,ε,ζ,η,θ,ι,κ,λ,μ,ν,ξ,ο,π,ρ,σ,τ,υ,φ,χ,ψ,ω,<hr>,А,Б,В,Г,Д,Е,Ё,Ж,З,И,Й,К,Л,М,Н,О,П,Р,С,Т,У,Ф,Х,Ц,Ч,Ш,Щ,Ъ,Ы,Ь,Э,Ю,Я,<hr>,а,б,в,г,д,е,ё,ж,з,и,й,к,л,м,н,о,п,р,с,т,у,ф,х,ц,ч,ш,щ,ъ,ы,ь,э,ю,я'
    ),
  },
  ...
  //{ name:"ewzm", title:lang.ewzm, content:toArray("")},
  {
    ...
    title: lang.zyzf,
    content: toArray(
      'ㄅ,ㄆ,ㄇ,ㄈ,ㄉ,ㄊ,ㄋ,ㄌ,ㄍ,ㄎ,ㄏ,ㄐ,ㄑ,ㄒ,ㄓ,ㄔ,ㄕ,ㄖ,ㄗ,ㄘ,ㄙ,ㄚ,ㄛ,ㄜ,ㄝ,ㄞ,ㄟ,ㄠ,ㄡ,ㄢ,ㄣ,ㄤ,ㄥ,ㄦ,ㄧ,ㄨ,<hr>,︰,￢,￤,℡,ˊ,ˋ,˙,–,―,‥,‵,∕,∟,∣,≒,≦,≧,⊿,═,║,╒,╓,╔,╕,╖,╗,╘,╙,╚,╛,╜,╝,╞,╟,╠,╡,╢,╣,╤,╥,╦,╧,╨,╩,╪,╫,╬,╭,╮,╯,╰,╱,╲,╳,▁,▂,▃,▄,▅,▆,▇,�,█,▉,▊,▋,▌,▍,▎,▏,▓,▔,▕,〒,〝,〞'
    ),
  },
];
